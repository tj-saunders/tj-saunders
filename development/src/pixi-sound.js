...
PIXI = PIXI || {}, PIXI.sound = function (t, e, n, o) {
  "use strict";
  ...
  var i = function () {
    ...
    return t.prototype.init = function (t, e) {
      ...
      _s = function s(t, e) {
    return (_s = Object.setPrototypeOf || _instanceof({
      __proto__: []
    }, Array) && function (t, e) {
      t.__proto__ = e;
    } || function (t, e) {
  ...
  var h = function () {
    ...
    DistortionFilter: function (t) {
      ...
      return u(e, t), Object.defineProperty(e.prototype, "amount", {
        ...
        set: function set(t) {
          ...
          for (var e, n = new Float32Array(44100), o = Math.PI / 180, i = 0; i < 44100; ++i) {
            e = 2 * i / 44100 - 1, n[i] = (3 + t) * e * 20 * o / (Math.PI + t * Math.abs(e));
          }
    ...
    ReverbFilter: function (t) {
      ...
      return u(e, t), e.prototype._clamp = function (t, e, n) {
        ...
        for (var t, e = p().context.audioContext, n = e.sampleRate, o = n * this._seconds, i = e.createBuffer(2, o, n), r = i.getChannelData(0), s = i.getChannelData(1), u = 0; u < o; u++) {
          t = this._reverse ? o - u : u, r[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay), s[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay);
        }
    ...
    return u(n, t), n.prototype.set = function (t, e) {
	  ...
	  console.log("this._source.volume = ", this._source.volume);
		  
	  // To stop crashing on IE11 :/
      this._source.volume = Math.min(1, i * n * o);
	  
	  console.log("this._speed = ", this._speed);
	  console.log("t.speed = ", t.speed);
  ...
  var I = function () {
    ...
    return t.from = function (e) {
      var n = {};
      return "string" == typeof e ? n.url = e : _instanceof(e, ArrayBuffer) || _instanceof(e, HTMLAudioElement) ? n.source = e : n = e, (n = _c({
        autoPlay: !1,
        singleInstance: !1,
        url: null,
        source: null,
      ...
      } else for (var n in this._sprites) {
    ...
    return t.prototype.init = function () {
      ...
      if ("string" == typeof t) {
        if (_instanceof(e, M)) return this._sounds[t] = e, e;
      ...
      return n = "string" == typeof t ? {
        url: t
      } : _instanceof(t, ArrayBuffer) || _instanceof(t, HTMLAudioElement) ? {
        source: t
      } : t, n = _c({}, n, e || {});
  ...
  var G = {
    ...
    playOnce: function playOnce(t, e) {
      var n = "alias" + R++;
      return p().add(n, {
        url: t,
        preload: !0,
    ...
    render: function render(t, e) {
      ...
      if (!_instanceof(t.media, _)) return i;
      var r = t.media,
          s = n.getContext("2d");
      s.fillStyle = e.fill;
    ...
    resolveUrl: S,
    sineTone: function sineTone(t, e) {
      void 0 === t && (t = 200), void 0 === e && (e = 1);
      var n = M.from({
        singleInstance: !0
      });
      if (!_instanceof(n.media, _)) return n;
